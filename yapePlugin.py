...
def tlGen(monkey):
    ...
    if(monkey.name == "Lucy"):
        ...
        image = pdb.gimp_file_load("/home/notes/Programming/yape-nft/Assets/lucy.xcf", "lucy.xcf")
        ...
        image = pdb.gimp_file_load("/home/notes/Programming/yape-nft/Assets/titus.xcf", "titus.xcf")
